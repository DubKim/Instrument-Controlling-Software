...
class fluxgate(QtCore.QThread): # Analog Input Task
    def __init__(self, nr = 1, vrange1=10, vrange2=10, sf=1000.0, taver=1, check=True, parent = None):
    ...
    def run(self):
        ...
        self.task.configure_timing_sample_clock(rate = self.sf, samples_per_channel=1) # Defining how, many samples you are going to get
